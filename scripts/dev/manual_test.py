...
# Call a tool
# result = mcp_client.call_tool("get_genie_usage_metrics", {"space_id": "01f165805e7219b4b9fafcafb541c7f2"})
# print(result.content)

result = mcp_client.call_tool(
    "get_genie_usage_metrics",
    {"space_id": "01f165805e7219b4b9fafcafb541c7f2", "timeout_seconds": 420},
)
print(result.content)
